...
public class Vaccination {
    ...
    public Queue<Integer> getVaccinationOrder(List<Person> people){
        PriorityQueue<Integer> vaccinationOrder = new PriorityQueue();
    ...
    public static void main(String[] args) {
        ...
        people.add(new Person("Szabó Fruzsina2", 28));
        people.add(new Person("Szabó Fruzsina3", 36));
        people.add(new Person("Szabó Fruzsina4", 42));
