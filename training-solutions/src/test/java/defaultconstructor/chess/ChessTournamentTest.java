...
//        System.out.println(chessTournament.getTeams().get(0).getPlayerOne().getName());
//        System.out.println(chessTournament.getTeams().get(0).getPlayerTwo().getName());
//        System.out.println(chessTournament.getTeams().get(1).getPlayerOne().getName());
//        System.out.println(chessTournament.getTeams().get(1).getPlayerTwo().getName());
//        System.out.println(chessTournament.getTeams().get(2).getPlayerOne().getName());
//        System.out.println(chessTournament.getTeams().get(2).getPlayerTwo().getName());
